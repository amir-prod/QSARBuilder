...
**Expected underfitting effect:** There is a risk of underfitting if the parameters are too restrictive; however, the chosen values should balance complexity and performance given the dataset size.

**Cost estimate:** Moderate, as the grid size is designed to be compact while still exploring a range of regularization options.
